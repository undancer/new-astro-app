...
/** */
export async function getStaticPathsBlogList({ paginate }) {
...
/** */
export async function getStaticPathsBlogCategory({ paginate }) {
...
/** */
export async function getStaticPathsBlogTag({ paginate }) {
